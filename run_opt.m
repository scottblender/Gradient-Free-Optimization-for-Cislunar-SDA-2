...
switch missionCfg.type
    ...
    case "LOW_THRUST_TRANSFER"
        ...
        assert(startsWith(missionCfg.transfer.depOrbitID, ...
            "northern_halo_l1:", "IgnoreCase", true), ...
            "Low-thrust departure must be a northern L1 halo orbit.");
        assert(startsWith(missionCfg.transfer.arrOrbitID, ...
            "southern_halo_l2:", "IgnoreCase", true), ...
            "Low-thrust arrival must be a southern L2 halo orbit.");

        safe_printf(["Low-thrust endpoints resolved by initial state:\n" ...
            "  Departure: row %d, slot %d, %s (error %.3e)\n" ...
            "  Arrival:   row %d, slot %d, %s (error %.3e)\n"], ...
            missionCfg.transfer.depOrbitIndex, ...
            missionCfg.transfer.depSlot, ...
            missionCfg.transfer.depOrbitID, depStateError, ...
            missionCfg.transfer.arrOrbitIndex, ...
            missionCfg.transfer.arrSlot, ...
            missionCfg.transfer.arrOrbitID, arrStateError);
