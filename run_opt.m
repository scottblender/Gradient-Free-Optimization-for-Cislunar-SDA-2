...
switch missionCfg.type
    ...
    case "LOW_THRUST_TRANSFER"
        ...
        assert(depSlotStateError <= 1e-10, ...
            "Departure slot IC does not match old row 52, slot 10. " + ...
            "State error = %.6e.",depSlotStateError);
        assert(arrSlotStateError <= 1e-10, ...
            "Arrival slot IC does not match old row 400, slot 1. " + ...
        ...
        safe_printf([ ...
            'Low-thrust endpoints resolved by initial and slot state:\n' ...
