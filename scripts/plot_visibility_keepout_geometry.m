...
% Keep this schematic on its previously enlarged canvas without changing any
% manuscript-wide figure settings. The extra height lets the equal-axis
% geometry and callouts occupy more of the exported EPS/PNG.
visibilityWidth = style.visibilityFigureWidth;
visibilityHeight = 6.4;
fig = figure( ...
    'Color','w', ...
    'Units','inches', ...
    'Position',[1,1,visibilityWidth,visibilityHeight], ...
    'PaperUnits','inches', ...
    'PaperPosition',[0,0,visibilityWidth,visibilityHeight], ...
    'PaperSize',[visibilityWidth,visibilityHeight], ...
