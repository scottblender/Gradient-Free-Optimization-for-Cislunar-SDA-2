...
%EXPORT_MANUSCRIPT_FIGURE Finalize and write a manuscript figure.
% The shared finalizer standardizes paper typography and fit-to-canvas layout;
% the writer then preserves the fixed paper canvas without further mutation.
