...
for kind=1:2
    ...
    if kind==1
        ...
        yOffset=0.035*diff(yl);
        orangeXOffset=0.05*diff(xl);
        orangeYOffset=0.085*diff(yl);
        text(ax,completionX(1),completionY(1)+yOffset,'6000 FE', ...
            'HorizontalAlignment','right','VerticalAlignment','bottom', ...
            'FontName',style.fontName,'FontSize',style.legendFontSize, ...
            'FontWeight','bold','Color',style.optimizerColors(1,:));
        text(ax,completionX(2)+orangeXOffset,completionY(2)+orangeYOffset,'6000 FE', ...
