...
value = replace(value,"Mean effective position sigma (km)","Effective position sigma (km)");
value = replace(value,"Mean position RMSE (km)","Position RMSE (km)");
value = replace(value,"Mean best-so-far objective","Best-so-far objective");
value = replace(value,"Mean screening violations","Screening violations");
