...
%
% This runs the real Gateway objective and existing final plotting.
...
for a = 1:numel(algorithms)
    for s = 1:numel(seeds)
        ...
        try
            ...
            row.totalBudgetOK = R.solverFunctionEvaluations == budget;
...
disp(summary(:, {
    ...
    'searchBudgetOK','totalBudgetOK','historyOK','bestOK', ...
